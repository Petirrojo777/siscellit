    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>FRIENDSHIP</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>FRIENDSHIP</b></span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="ventas/venta"><i class="fa fa-circle-o"></i> Pedidos Recientes</a></li>
                <li><a href="ventas/cliente"><i class="fa fa-circle-o"></i> Pedidos en espera</a></li>
              </ul>
            </li>
